...
"[project]/src/app/adminpanel/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminPanel() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError('');
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiCall"])('/api/auth/login', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
//# sourceMappingURL=_0f0abe81._.js.map